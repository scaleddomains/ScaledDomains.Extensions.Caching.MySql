...
namespace ScaledDomains.Extensions.Caching.MySql.Tests
{
    ...
    public class MySqlServerCacheMaintenanceServiceTests : IntegrationTestBase
    {
        ...
        public async Task ExecuteAsync_DeleteExpiredCacheItemsAsyncInvokeOnce()
        {
            ...
            _databaseOperationsMock.Verify(m => m.DeleteExpiredCacheItemsAsync(It.IsAny<CancellationToken>()));
        }
        ...
        public async Task ExecuteAsync_DisposeBeforeStart_DeleteExpiredCacheItemsAsyncNeverInvoked()
        {
            ...
            _databaseOperationsMock.Verify(m => m.DeleteExpiredCacheItemsAsync(It.IsAny<CancellationToken>()), Times.Never);
        }
